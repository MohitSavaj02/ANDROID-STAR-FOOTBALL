...
@AndroidEntryPoint
class ResultActivity : BaseActivity(), View.OnClickListener, ResultAdaptor.ResultListener {
    private lateinit var binding: ActivityCommonBinding
    private lateinit var adaptor: ResultAdaptor
    ...
    private fun initViews() {
        binding.txtTitle.text = R.string.result.asString()
